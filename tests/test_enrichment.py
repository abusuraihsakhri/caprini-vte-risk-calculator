"""
Automated Pytest for caprini-vte-risk-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    CaprinivteriskcalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CaprinivteriskcalculatorEnrichmentSuite()
