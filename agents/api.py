"""
FastAPI REST API Server for Caprini Vte Risk Calculator.
"""
...
app = FastAPI(
    title="Caprini Vte Risk Calculator API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "caprini-vte-risk-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
